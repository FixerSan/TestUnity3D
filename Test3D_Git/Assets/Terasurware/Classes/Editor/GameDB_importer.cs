...
public class GameDB_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/GameDB.xlsx";
	private static readonly string exportPath = "Assets/GameDB.asset";
	private static readonly string[] sheetNames = { "GameDB", };
